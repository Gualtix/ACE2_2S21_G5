...
export default class Configuraciones extends React.Component{
    ...
    render(){
        const {Nombre, Ubicacion, Silla, Tiempo} = this.state
        return(
            <div className="container">
                <form onSubmit = {this.submitHandler}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" className="form-control" name="Tiempo" aria-describedby="idHelp" placeholder="time" value={Tiempo} onChange={this.changeHandler} ></input>
                        <small id="idHelp" className="form-text text-muted">Agregue el Tiempo</small>
                    </div>
                    <br/>
